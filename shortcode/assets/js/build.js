...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        _axios2.default.get(wp_data.plugin_dir_url + 'assets/price1.json').then(function (response) {
            ...
            var filterArray = _lodash2.default.filter(_this.info.data.metadata.area, function (item) {
                return item.id < 10;
            });
            _lodash2.default.forEach(filterArray, function (item) {
                _this.address.options[0].area.push(item);
            });
            filterArray = _lodash2.default.filter(_this.info.data.metadata.area, function (item) {
                return item.id >= 10;
            });
            ...
            _lodash2.default.forEach(filterArray, function (item) {
                _this.address.options[1].area.push(item);
            });

            _lodash2.default.forEach(_this.info.data.metadata.car, function (item) {
                _this.car.options.push(item);
            });

            _lodash2.default.forEach(_this.info.data.metadata.time_delivery, function (item) {
                _this.time_delivery.options.push(item);
            });
...
},{"axios":3,"lodash":29,"vue":35,"vue-hot-reload-api":32}],2:[function(require,module,exports){
'use strict';
...
},{"../components/App.vue":1,"vue":35,"vue-multiselect":33,"vue-select":34}],3:[function(require,module,exports){
